...
<div class="element <?php echo $element->elementType->class_name?>"
	...
	<?php echo $form->dropDownList($element, 'scrub_nurse_id', CHtml::listData(User::model()->active()->findAll(array('order'=>'first_name,last_name')),'id','fullName'), array('empty'=>'- Select -'))?>
	<?php echo $form->dropDownList($element, 'circulating_nurse_id', CHtml::listData(User::model()->active()->findAll(array('order'=>'first_name,last_name')),'id','fullName'), array('empty'=>'- Select -'))?>
	<?php echo $form->dropDownList($element, 'anaesthetic_nurse_id', CHtml::listData(User::model()->active()->findAll(array('order'=>'first_name,last_name')),'id','fullName'), array('empty'=>'- Select -'))?>
</div>
